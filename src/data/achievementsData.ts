...
export const achievements: Achievement[] = [
  {
    ...
    description: "Clasificación directa para la competición nacional F1 in Schools 2024, representando a la Comunidad de Madrid tras obtener el primer puesto regional"
  },
  {
    icon: "Target",
